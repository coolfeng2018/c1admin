...
class UserWhiteListController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (UserWhiteListModel::create($data)){
            return redirect(route('admin.whitelist'))->with(['status'=>'添加完成']);
        }
        return redirect(route('admin.whitelist'))->with(['status'=>'系统错误']);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.whitelist.edit',compact('payInfo'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($payInfo->update($data)){
            return redirect(route('admin.whitelist'))->with(['status'=>'更新成功']);
        }
        return redirect(route('admin.whitelist'))->withErrors(['status'=>'更新失败']);
    }
